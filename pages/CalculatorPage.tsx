            ...
            <div className="flex-1 flex flex-col h-full overflow-hidden relative z-10">
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar px-3 sm:px-6 lg:px-8 py-4 sm:py-6">
                    <div className="w-full max-w-[1600px] mx-auto flex flex-col min-h-full">
                        ...
                        <div className="2xl:hidden mt-auto pt-8 pb-4">
                             <a 
                                href={getWhatsappLink("Soluções de Caldeiraria e Industrial")} 
                                target="_blank"
                                rel="noopener noreferrer"
                                className="block relative h-32 sm:h-40 w-full rounded-xl overflow-hidden border border-white/10 shadow-lg group"
                             >
